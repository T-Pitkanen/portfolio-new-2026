...
const timeline = [
  ...
  },
  {
    ...
    description: 'Back in Finland, studying Business IT. Where software development meets business systems. Databases & APIs has been my favorite course so far.',
  },
  {
    year: 'Now',
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.grid}>
          ...
          <div className={`reveal ${styles.bio}`} data-delay="1">
            <p>
              I have a web development degree from Denmark and I&apos;m in my second year of Business IT at <span className={styles.bioHighlight}>VAMK</span>. My current courses cover databases, APIs, cloud services, and UX. The databases side has ended up being what I enjoy most.
            </p>
            <p>
